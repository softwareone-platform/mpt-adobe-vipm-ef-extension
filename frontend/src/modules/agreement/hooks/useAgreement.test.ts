...
const EXPECTED_AGREEMENT: Agreement = {
  id: 'AGR-1111-2222',
  status: 'Active',
  parameters: {
    fulfillment: [
      ...
      {
        id: 'PRM-1111-1111',
        externalId: '3YCMinConsumables',
        type: 'int',
        multiple: false,
        name: '3YCMinConsumables',
        value: 100,
        displayValue: '5900',
      },
      {
      ...
      },
      {
        ...
        type: 'string',
        multiple: false,
        name: '3YCCommitmentRequestStatus',
        value: 'Active',
        displayValue: '6300',
      },
      {
        ...
        type: 'int',
        multiple: false,
        name: '3YCCommitmentRequestLicenses',
        value: 100,
        displayValue: '6100',
      },
      {
        ...
        type: 'int',
        multiple: false,
        name: '3YCCommitmentRequestConsumables',
        value: 100,
        displayValue: '6200',
      },
      {
        ...
        type: 'date',
        multiple: false,
        name: '3YCCommitmentRequestStartDate',
        value: '2026-01-01',
        displayValue: '6300',
      },
      {
        ...
        type: 'date',
        multiple: false,
        name: '3YCCommitmentRequestEndDate',
        value: '2026-01-01',
        displayValue: '6400',
      },
      {
        ...
        type: 'string',
        multiple: false,
        name: '3YCRecommitmentRequestStatus',
        value: null,
        displayValue: '6500',
      },
      {
        ...
        type: 'int',
        multiple: false,
        name: '3YCRecommitmentRequestLicenses',
        value: null,
        displayValue: '6700',
      },
      {
        ...
        type: 'int',
        multiple: false,
        name: '3YCRecommitmentRequestConsumables',
        value: null,
        displayValue: '6800',
      },
      {
        ...
        type: 'date',
        multiple: false,
        name: '3YCRecommitmentRequestStartDate',
        value: null,
        displayValue: '6900',
      },
      {
        ...
        type: 'date',
        multiple: false,
        name: '3YCRecommitmentRequestEndDate',
        value: '2026-01-01',
        displayValue: '7000',
      },
    ],
...
describe('useAgreement', () => {
  it('returns the hardcoded agreement', () => {
    const { result } = renderHook(() => useAgreement());

    expect(result.current).toEqual(EXPECTED_AGREEMENT);
  });
});
