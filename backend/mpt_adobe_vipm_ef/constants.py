...
SCHEDULED_SUBSCRIPTION_STATUS = "1009"

FLEX_DISCOUNT_SUCCESS_RESULT = "SUCCESS"
FLEX_DISCOUNT_REASON_PATTERN = r"Reason: ?([A-Z_]+)\b"
FLEX_DISCOUNT_BARE_REASON_PATTERN = r"[A-Z][A-Z_]+"
FLEX_DISCOUNT_ERROR_CODES = ("2141", "2146", "2147")
FLEX_DISCOUNT_LINE_PATTERN = r"Line Item: ?(\d+)"
